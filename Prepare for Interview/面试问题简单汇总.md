...
它是强一致性的吗？  
它为什么是弱一致性的？   
ConcurrentHashMap 1.7 和 1.8 是如何扩容的？**sizeCtl** 参数是干什么的，讲讲变换过程？  
为什么要用 volatile 修饰？  
说说它的功能？什么是 MESI 协议？

##Muti-threading and Concurrency  
###CPU 原语是什么？  
[CAS, cpu 硬件同步原语](https://baike.baidu.com/item/CAS/7371138)  
###什么是可见性？   
[三大性质总结：原子性，有序性，可见性](https://www.jianshu.com/p/cf57726e77f2)  
###JMM 说说是什么？    
[Java memory model](https://zhuanlan.zhihu.com/p/258393139)  
###为什么要有 JMM？  
[Happened-before](https://en.wikipedia.org/wiki/Happened-before) 是什么？  
###它和 synchronized 的区别是什么？  
[从 JMM 透析 volatile 与 synchronized 原理](https://segmentfault.com/a/1190000037742921)  
###锁的升级与降级说下是什么？  
###自旋锁是什么？  
###偏向锁是什么？  
###Mark-Word 说下？  
...
###为什么要引入 CAS？ABA 问题是如何解决的？  
###AQS 了解吗？它是如何实现的？  
###CLH 又是什么？ReentrantLock 和 synchronized 区别是什么？  
